...
export default function MicedChart(props) {
        return (
            <>
                <h4 className={'pt-2 font-weight-bold px-2'}>Students Active Timing</h4>
                <p className={'px-2'}>Last 28 days</p>
            <ResponsiveContainer width="100%" height={300} aspect={0}>
                <BarChart width={500} height={300} data={props.data} margin={{top: 20,right: 30,left: 20,bottom: 5,}}>
