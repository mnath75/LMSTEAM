...
const cards=[
    {title:'Sign Ups',value:'4.5K ',des:'3.2K more than usual'},
    {title:'Apps Downloads',value:'4.5K ',des:'3.2K more than usual'},
    {title:' Courses Sold',value:'4.5K ',des:'3.2K more than usual'},
    {title:'Revenue',value:'7.5K ',des:'3.2K more than usual'},
]
const pdata = [
    {
        date: 'Dec 10 2021',
        ...
        <div className={classes.root}>
            <Grid container>
                ...
                <Grid item xs={12} sm={6} md={6} lg={3} >
                    <div onClick={()=>{GetData(index)}} className={classes.box} style={{  borderTop: active ===index?'3px solid blue':'3px solid transparent',background:active===index?'#fff':'#eee'}}>
